...
$subscriptionProd = " __$$$__ "
$subscriptionSanbox = " __$$$__ "
...
Invoke-RestMethod -uri "https://$URI/jira/rest/auth/latest/session" -ContentType "application/json" -Method POST -body $auth -SessionVariable mysession
...
# issuetype 10001 = story, no sub tasks, no parent issue
 $global:IssueBody = 
@{
 fields = @{ 
 ...
 priority = @{ id = '1' }
                    ...
                    $IssueCreation = Invoke-WebRequest -uri "https://$URI/jira/rest/api/latest/issue/" -ContentType "application/json" -Method POST -Body $IssueBody -WebSession $mysession -UseBasicParsing | ConvertFrom-Json
